...
class ParseTagVersionTest extends Specification{
    ...
    def "Parse type of version properly"() {
        ...
        where:
        str | expected
        "v1.0"  | new TagVersion(BigDecimal.ONE, VersionType.MASTER)
        "v1.1-rc"  | new TagVersion(BigDecimal.valueOf(1.1), VersionType.STAGE)
        "v1.1-SNAPSHOT"  | new TagVersion(BigDecimal.valueOf(1.1), VersionType.OTHER)
        "v1.4"  | new TagVersion(BigDecimal.valueOf(1.4), VersionType.DEV_OR_QA)
